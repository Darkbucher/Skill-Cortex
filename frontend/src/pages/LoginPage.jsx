...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    if (!isLoaded || isGoogleSigningIn || isSigningIn) return;
          ...
          {!showPasswordForm ? (
            <>
              ...
              <button
                ...
                disabled={!isLoaded || isGoogleSigningIn || isSigningIn}
                className="w-full flex items-center justify-center gap-3 bg-neutral-900 hover:bg-black dark:bg-neutral-100 dark:hover:bg-white text-white dark:text-neutral-900 font-medium py-3.5 px-4 rounded-xl transition-colors mb-6 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
                {isGoogleSigningIn ? (
